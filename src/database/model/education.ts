...
export const Degrees = enumeratedLiterals(
  [
    { label: 'Bachelors of Science', shortLabel: 'B.S.', value: DegreeType.BACHELORS_OF_SCIENCE },
    { label: 'Masters of Science', shortLabel: 'M.S.', value: DegreeType.MASTERS_OF_SCIENCE },
    {
      label: 'Masters of Science in Engineering',
      shortLabel: 'M.S.E.',
      value: DegreeType.MASTERS_OF_SCIENCE_IN_ENGINEERING,
    },
  ] as const satisfies { label: string; shortLabel: string; value: DegreeType }[],
  {},
);
