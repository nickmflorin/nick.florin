...
export interface StreamedEducationSelectProps<B extends SelectBehaviorType> extends Omit<
  EducationSelectProps<B>,
  'data'
> {
  /**
...
/**
 * An {@link EducationSelect} fed by a server-started promise rather than a client-side fetch.
 *
 ...
 */
export const StreamedEducationSelect = <B extends SelectBehaviorType>({
  dataPromise,
  onError,
  ref,
  ...props
...
} & StreamedEducationSelectProps<B>): JSX.Element => {
