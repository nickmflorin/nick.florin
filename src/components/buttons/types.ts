...
export const ButtonSizes = enumeratedLiterals(["xsmall", "small", "medium", "large"] as const, {});
...
type IfForm<T, F extends ButtonForm, O extends ButtonOptions> = F extends GetButtonForm<O>
  ? T
  : never;
