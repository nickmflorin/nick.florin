...
export type MenuOptions<I extends MenuModel> = Partial<{
  ...
  readonly getItemLabel: (m: I, opts: { isMulti: boolean; isNullable: boolean }) => ReactNode;
  // TODO: We may want to move this to the Select since it is not applicable to the generic Menu.
  readonly getItemValueLabel: (m: I, opts: { isMulti: boolean; isNullable: boolean }) => ReactNode;
