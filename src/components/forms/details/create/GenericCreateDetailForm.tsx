...
export interface GenericCreateDetailFormProps<D extends FullApiDetail | NestedApiDetail>
  extends Omit<
    DetailFormProps,
...
export const GenericCreateDetailForm = <D extends FullApiDetail | NestedApiDetail>({
  action,
  onCreated,
  onCancel,
  ...props
