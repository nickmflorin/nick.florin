<!-- Parity: keep in sync with .github/instructions/discovery.instructions.md -->
...
| Situation                                                   | Action                                     |
| ----------------------------------------------------------- | ------------------------------------------ |
| File location is in the [codebase index](codebase-index.md) | Go directly to the file (no search needed) |
