...
applyTo: '**/*.{ts,tsx}'
description:
  'Derived object literals: destructure/spread with lodash-es omit/pick instead of restating
  funneled properties'
---

<!-- Parity: keep in sync with .claude/rules/code-quality/typescript/object-mapping.md -->
