...
<!-- Parity: keep in sync with .claude/rules/workflow/verification-commands.md -->
...
[eslint.instructions.md](../code-quality/eslint.instructions.md)), the spelling rules (see
[spelling.instructions.md](../code-quality/spelling.instructions.md)), and the existing tests.
Reason about correctness while writing the code rather than deferring it to a command you are not
going to run.
