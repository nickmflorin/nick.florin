...
<!-- Parity: keep in sync with .claude/rules/workflow/agent-behavior.md -->

# Agent Behavior

How AI coding agents approach changes in this repository. Complements
[discovery.md](../discovery.instructions.md), which covers search delegation.
...
[codebase index](../codebase-index.instructions.md) names a reference example for each placement
convention.
